...
| **Page filter** | Optional `pageFilter` on a Content Manager view or listing that gates scans against active mapped-page names (`!!` exclusions supported). See [Page filter](./modules/content-manager.md#page-filter). |
